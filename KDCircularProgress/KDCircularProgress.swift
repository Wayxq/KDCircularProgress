...
//    var trackStartAngle: Double = 0
//    var /*trackEndAngle*/: Double = CGFloat.pi * 2.0
    ...
    private class KDCircularProgressViewLayer: CALayer {
        ...
        override func draw(in ctx: CGContext) {
            ...
            ctx.addArc(center: CGPoint(x: width / 2.0, y: height / 2.0), radius: arcRadius, startAngle: trackStartAngle, endAngle: trackEndAngle, clockwise: false)
            trackColor.set()
